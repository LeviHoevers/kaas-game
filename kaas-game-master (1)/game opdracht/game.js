...
firstmove = firstmove.toLowerCase();
	if  (firstmove == "down") {  alert("u made it safely to prof. oak's lab")
}
	else if (firstmove == "up")
	alert("u headed upwards. u walked through some tall grass but have no pokemon to defend yourself! game over")
}
	else if (firstmove == "right") alert("hej hej")
...
alert("sorry but you're not old enough to play this game.\n ");
